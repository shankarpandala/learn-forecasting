...
export default function Section_s3_probabilistic_inventory() {
  return (
    <SectionLayout
      title="Probabilistic Inventory"
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            This section covers Probabilistic Inventory as part of the forecasting curriculum.
