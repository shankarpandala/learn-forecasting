...
export default function Section_s2_reconciliation_sc() {
  return (
    <SectionLayout
      title="Reconciliation Sc"
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            This section covers Reconciliation Sc as part of the forecasting curriculum.
