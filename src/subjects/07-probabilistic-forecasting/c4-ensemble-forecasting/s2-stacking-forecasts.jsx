...
export default function Section_s2_stacking_forecasts() {
  return (
    <SectionLayout
      title="Stacking Forecasts"
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            This section covers Stacking Forecasts as part of the forecasting curriculum.
