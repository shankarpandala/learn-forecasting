...
export default function Section_s2_adaptive_conformal() {
  return (
    <SectionLayout
      title="Adaptive Conformal"
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            This section covers Adaptive Conformal as part of the forecasting curriculum.
