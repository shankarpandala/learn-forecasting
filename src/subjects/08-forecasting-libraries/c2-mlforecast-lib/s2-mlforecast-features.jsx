...
export default function Section_s2_mlforecast_features() {
  return (
    <SectionLayout
      title="Mlforecast Features"
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            This section covers Mlforecast Features as part of the forecasting curriculum.
