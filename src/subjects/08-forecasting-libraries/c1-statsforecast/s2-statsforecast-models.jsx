...
export default function Section_s2_statsforecast_models() {
  return (
    <SectionLayout
      title="Statsforecast Models"
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            This section covers Statsforecast Models as part of the forecasting curriculum.
