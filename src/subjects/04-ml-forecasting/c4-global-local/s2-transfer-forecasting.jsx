...
export default function Section_s2_transfer_forecasting() {
  return (
    <SectionLayout
      title="Transfer Forecasting"
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            This section covers Transfer Forecasting as part of the forecasting curriculum.
